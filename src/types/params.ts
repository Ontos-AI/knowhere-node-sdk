...
export interface ParseParams {
  ...
  signal?: AbortSignal;
  /**
   * @deprecated Page citation assets are generated by Knowhere during parsing
   * and returned on page chunks when available. This option is accepted for
   * compatibility and no longer triggers SDK-side rendering.
   */
  pageCitationAssets?: Record<string, unknown>;
}
